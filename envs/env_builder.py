...
from tasks import walk_along_x, default_task, walk_along_x_v3, walk_along_x_v4, walk_along_x_v7, walk_along_x_v5, walk_along_x_v6
...
def build_regular_env(args, 
    ...
    task = walk_along_x_v7.WalkAlongX()
